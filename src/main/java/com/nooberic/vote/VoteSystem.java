...
public class VoteSystem implements ModInitializer {
    public static final String MOD_ID = "vote-system";
    ...
    public static final VoteManager VOTE_MANAGER = new VoteManager();
